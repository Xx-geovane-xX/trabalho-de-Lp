 ...
 * @author u05682855140
 */
public class JDlgTipoNovo extends javax.swing.JDialog {

    JDlgTipoNovoIA jDlgTipoNovoIA;
    TipoDAO tipoDAO;
    TipoControle tipoControle;
    GasTipo gasTipo;
    
    /**
     * Creates new form JDlgTipoNovo
     */
    public JDlgTipoNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Tipo");
        setLocationRelativeTo(null);
        jDlgTipoNovoIA = new JDlgTipoNovoIA(null, true);
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        ...
        jDlgTipoNovoIA.setTitle("Inclusão");
        jDlgTipoNovoIA.setVisible(true);
    }//GEN-LAST:event_jBtnIncluirActionPerformed

    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        // TODO add your handling code here:
        jDlgTipoNovoIA.setTitle("Alteração");
        jDlgTipoNovoIA.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgTipoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgTipoNovo dialog = new JDlgTipoNovo(new javax.swing.JFrame(), true);
